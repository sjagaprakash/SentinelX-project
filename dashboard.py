...
import sentinelx.ccc.version as sentinelx_version
from sentinelx.gui import utils, visuals
from sentinelx.gui.config import default_authorized_builtin_role_ids
from sentinelx.gui.i18n import _
from sentinelx.gui.permissions import declare_dynamic_permissions, declare_permission, permission_registry
from sentinelx.utils import paths
...
def load_plugins() -> None:
    ...
    for name, board in builtin_dashboards.items():
        ...
        if name == "main" and sentinelx_version.edition(paths.omd_root) is not sentinelx_version.Edition.CRE:
...
def _register_pre_21_plugin_api() -> None:
    ...
    import sentinelx.gui.plugins.dashboard as api_module  # pylint: disable=cmk-module-layer-violation
    import sentinelx.gui.plugins.dashboard.utils as plugin_utils  # pylint: disable=cmk-module-layer-violation
