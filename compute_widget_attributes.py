...
from sentinelx.gui.logged_in import user
from sentinelx.gui.openapi.framework import (
    APIVersion,
    EndpointDoc,
    EndpointHandler,
    EndpointMetadata,
...
from sentinelx.gui.openapi.framework.model import api_field, api_model
from sentinelx.gui.openapi.restful_objects.constructors import domain_type_action_href
...
ENDPOINT_COMPUTE_WIDGET_ATTRIBUTES = VersionedEndpoint(
    metadata=EndpointMetadata(
        ...
        link_relation="sentinelx/compute",
        method="post",
    ),
